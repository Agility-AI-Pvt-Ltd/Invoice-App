...
// const headerLabels: Record<PlanKey, string> = {
//   Starter: "Starter ₹2,499 (1 User + 1 Admin)",
//   Premium: "Premium ₹3,499 (3 Users + 1 Admin)",
//   Diamond: "Diamond ₹5,499 (5 Users: 2 Admin + 2 Manager + 1 Exec)",
// };
...
//     values: {
//       Starter: "1 Admin",
//       Premium: "1 Admin + 2 Team Members",
//       Diamond: "2 Admin + 2 Manager + 1 Executive",
//     },
//   },
//   { label: "Unlimited Invoices", values: { Starter: true, Premium: true, Diamond: true } },
//   { label: "Income & Expense Tracking", values: { Starter: true, Premium: true, Diamond: true } },
//   {
//     label: "Invoice Scan (auto data capture)",
//     values: {
//       Starter: {enabled:true, note:"(basic)"},
//       Premium: true,
//       Diamond: { enabled: true, note: "(bulk upload + advanced)" },
//     },
//   },
//   { label: "GST-Compliant Invoices", values: { Starter: true, Premium: true, Diamond: true } },
//   { label: "Automated Payment Reminders", values: { Starter: true, Premium: true, Diamond: true } },
//   { label: "Recurring Invoices & Auto-Billing", values: { Starter: false, Premium: true, Diamond: true } },
//   { label: "Expense Categorization & Tags", values: { Starter: false, Premium: true, Diamond: true } },
//   {
//     label: "Reports (P&L, Tax, Expense)",
//     values: {
//       Starter: { enabled: false, note: "(basic tax summary only)" },
//       Premium: { enabled: true, note: "(standard reports)" },
//       Diamond: { enabled: true, note: "(advanced dashboards & analytics)" },
//     },
//   },
//   { label: "Payment Tracking & Partial Payments", values: { Starter: false, Premium: true, Diamond: true } },
//   { label: "Approval Workflows", values: { Starter: false, Premium: false, Diamond: true } },
//   { label: "Custom Invoice Templates", values: { Starter: false, Premium: false, Diamond: true } },
//   { label: "Audit Trail & Activity Logs", values: { Starter: false, Premium: false, Diamond: true } },
//   { label: "Data Export & Backup", values: { Starter: false, Premium: false, Diamond: true } },
// ];
...
//   // changed filter: "key" = only rows where ALL plans have a tick
//   const rows = useMemo(() => {
//     if (mode === "key") {
//       return allRows.filter((r) => plans.every((p) => isEnabled(r.values[p])));
//     }
//     return allRows;
//   }, [mode]);
