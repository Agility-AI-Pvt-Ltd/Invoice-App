...
export const SETTINGS_API = {
  PROFILE: `${BASE_URL}/api/auth/profile`, // Get user profile
  CHANGE_PASSWORD: `${BASE_URL}/api/reset-password`, // Change password
  UPLOAD_LOGO: `${BASE_URL}/api/profile/logo`, // Upload business logo (not implemented)
